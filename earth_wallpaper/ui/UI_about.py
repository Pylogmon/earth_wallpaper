...
class Ui_About(object):
    def setupUi(self, About):
        ...
        self.verticalSpacer_2 = QSpacerItem(
            20, 78, QSizePolicy.Minimum, QSizePolicy.Expanding)
    ...
    def retranslateUi(self, About):
        About.setWindowTitle(QCoreApplication.translate(
            "About", u"\u5173\u4e8e", None))
        self.label.setText(QCoreApplication.translate(
            "About", u"Earth Wallpaper", None))
        self.version.setText(
            QCoreApplication.translate("About", u"1.3.0", None))
        self.aboutQt.setText(QCoreApplication.translate("About", u"Qt", None))
        self.checkUpdate.setText(QCoreApplication.translate(
            "About", u"\u68c0\u67e5\u66f4\u65b0", None))
